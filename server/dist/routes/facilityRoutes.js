...
import { getAllFacilities, getFacilityById, getFacilityReservations, createFacility, updateFacility, deleteFacility, setMaintenance, clearMaintenance, getFacilityBySlug } from "../controllers/facilityController.js";
import { authenticateToken, authorizeAdmin } from "../middlewares/authMiddleware.js";
import { validate } from "../middlewares/validate.js";
import { createFacilitySchema, updateFacilitySchema, facilityIdSchema, getFacilitiesQuerySchema } from "../schemas/facility.schema.js";
const router = Router();
