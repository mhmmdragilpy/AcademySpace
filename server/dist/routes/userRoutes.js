...
import { getAllUsers, getUserById, updateUser, deleteUser, promoteToAdmin, demoteToUser, createUser, updateProfileAvatar, deleteProfileAvatar, getMyProfile, updateMyProfile, suspendUser, unsuspendUser } from "../controllers/userController.js";
...
// router.put("/:id", authenticateToken, authorizeAdmin, validate(updateUserSchema), updateUser); // Disabled: Admin should not manage user profiles
