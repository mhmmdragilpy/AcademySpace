...
export const emailService = {
    async sendReservationStatusEmail(userEmail, userName, facilityName, date, startTime, endTime, status, purpose) {
        if (!transporter) {
    ...
    async sendReservationCreatedEmail(userEmail, userName, facilityName, date, startTime, endTime, purpose) {
        if (!transporter) {
            logger.warn('Email service not configured. Missing SMTP environment variables.');
            return;
        }
