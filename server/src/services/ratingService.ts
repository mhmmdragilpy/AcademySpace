...
export class RatingService {
    ...
    async getRatingsByFacility(facilityId: number) {
        return this.ratingRepository.findByFacilityId(facilityId);
    }

    async getAverageRatingForFacility(facilityId: number) {
    ...
    async getUserRatingForReservation(userId: number, reservationId: number) {
